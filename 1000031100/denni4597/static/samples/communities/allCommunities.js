	...
	require(["dojo/domReady!"], function(){
        ...
        var intId = setInterval(function(){
            ...
            waitFor( function(){
				...
				var content = document.createTextNode("Please follow company policy or seek guidance at www.ibm.com");
				var br = document.createElement("br");
				dojo.query(".lotusMeta")[2].append(br);
				dojo.query(".lotusMeta")[2].append(content);
